...
#define HAVE_CLEANUP_JMP_BUF
  ...
  /* Flags determining process of thread cancellation, termination, and
     finalization.  Initial state 0 is set at allocate_stack
     (pthread_create.c).
     ...
     is set atomically either by

       1. pthread_exit call.
       2. thread cancellation signal handler at nptl-init.c.
       3. after thread execution at pthread_create.c.
